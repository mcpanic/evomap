...
// you use that seed number.
	...
	std::ifstream fp_in;  // declarations of streams fp_in and fp_out
	fp_in.open("sample450", std::ios::in);    // open the streams
	fp_in >> numedge >> numnode;
	EdgeMatrix = (bool**)malloc(sizeof(bool*)*numnode);
	for(int i = 0; i < numnode; i++)
	{
		EdgeMatrix[i] = (bool*)malloc(sizeof(bool)*numnode);
